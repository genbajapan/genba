...
- 原則として、1本目は創業者の一次経験を一般化した転職判断・営業キャリア投稿、2本目は認知度の低い外資1社を扱う具体的な企業研究投稿とする
- 企業研究投稿は、意外性のある冒頭、公式情報に基づく固有の魅力、`仕事として見ると`、応募前に確認すべき点を含め、該当企業ページへつなぐ。会社説明、求人列挙、サイト更新告知だけで完結させない
- 毎投稿をGenba告知にせず、1本目は原則リンクなし、2本目は企業ページへの計測リンク付きとする。重要な速報等で組み合わせを変える場合も、2本とも単独告知にはしない

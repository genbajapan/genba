...
- 通常のデイリータスクでは引き続き日本進出済み企業を追加する。「日本未進出の注目企業」はGongを起点に標準フォーマットを確定済みだが、Jioがその回に明示した場合だけ追加し、現在応募できる企業・求人と同じ集計へ混ぜない
...
- 日本未進出企業を明示指示で扱う場合は、`ops/pre-entry-company-standard.md`を必ず最初から最後まで読み、Gongを正準サンプルとする同一構造・同等以上の情報密度で作成する。国内情報が少ないことを理由に薄くせず、海外公式の業績・資金調達・顧客事例・製品・Trust、APACの公式拠点と求人、製品の日本語対応、海外GTM人材の公開プロフィール集計、日本進出の追い風と障壁を横断する。日本法人・日本求人・国内顧客がないこと自体も反証として保存する
...
- 新着・終了求人の差分、注目企業1社、外資AE向け海外一次情報の要点を基本構成とする。ただし、確認できる重要な変化がない項目を件数合わせで作らない

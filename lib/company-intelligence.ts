...
const categoryLenses: Record<string, CategoryLens> = {
  "CRM / AI": {
    ...
    buyers: ["営業", "マーケティング", "カスタマーサービス", "IT"],
  ...
  "CRM / Marketing": {
    cluster: "Revenue Platform",
    buyers: ["マーケティング", "営業", "カスタマーサービス", "経営"],

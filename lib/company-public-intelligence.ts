...
const confluentIntelligence: CompanyPublicIntelligence = {
  ...
  marketStatus: {
    isPublic: false,
    ipoOutlookSummary: "Confluentは2021年6月にNASDAQへ上場していたが、2026年3月17日にIBMが1株31ドル・総額約110億ドルで買収を完了し、完全子会社化・上場廃止となった。したがって今後の新規上場(再IPO)の可能性は極めて低く、IBMの一事業として運営される見通し。IBMはConfluentのリアルタイムデータストリーミング技術を、自社のAI・エンタープライズソフトウェア戦略の中核に据える方針を示している。買収直後のため、日本を含む営業組織の統合方針・目標設定がどう変わるかは、公開情報だけでは確認できていない。",
    outlookSignals: [
      { label: "IBMによる完全子会社化", detail: "2026年3月17日、約110億ドル(1株31ドル)で買収完了、NASDAQ上場廃止", direction: "中立", sourceId: "confluent-ibm-acquisition" },
      { label: "IBMのAI戦略の中核に位置づけ", detail: "IBMはConfluentのリアルタイムデータをエンタープライズAI・エージェント活用の基盤にする方針を表明", direction: "追い風", sourceId: "confluent-ibm-acquisition" },
      { label: "買収直後で組織統合の詳細が不透明", detail: "日本を含む営業組織の統合方針・評価制度の変更点は公開情報からは確認できていない", direction: "逆風", sourceId: "confluent-ibm-acquisition" },
    ],
...
const pagerdutySources: ResearchSource[] = [
  ...
  {
    id: "pagerduty-stock-price",
    label: "stockanalysis.com PagerDuty(PD)株価データ",
    url: "https://stockanalysis.com/stocks/pd/",
    kind: "外部集計",
    scope: "株価・時価総額・52週レンジ",
    checkedAt: "2026-08-07",
  },
  {
    id: "pagerduty-stock-forecast",
    label: "stockanalysis.com PagerDuty(PD)アナリスト予想",
    url: "https://stockanalysis.com/stocks/pd/forecast/",
    kind: "外部集計",
    scope: "アナリスト目標株価コンセンサス",
    checkedAt: "2026-08-07",
  },
...
const pagerdutyIntelligence: CompanyPublicIntelligence = {
  ...
  marketStatus: {
    ...
    priceAsOf: "2026-08-06",
    price: "$11.10",
    marketCap: "$856.06M(約1,344億円)",
    week52Range: "$5.70〜$17.29",
    analystConsensus: "Hold",
    analystTargetAvg: "$9.43(現在値-15.05%)",
    analystTargetRange: "$8.00〜$11.00",
    analystCount: "9人",
    outlookSummary: "Q1 FY27(2026年5月発表)決算は売上1.21億ドル(前年比+1%)、ARRは4.96億ドルで前年とほぼ横ばい。$100,000以上のARR顧客は860社(前年比+1%)とわずかな伸びにとどまり、ドルベースの純増収率(NRR)は97%と、前年の104%から悪化し、既存顧客からの純増収がマイナスに転じている。株価は52週で大きく下落しており、アナリスト評価もHoldにとどまる。インシデント管理という成熟市場でDatadogやOpsgenie等との競争が激化していることが、成長鈍化の背景にあると考えられる。",
    outlookSignals: [
      { label: "ARR・売上ともほぼ横ばい", detail: "売上は前年比+1%、ARRは前年とほぼ同水準の4.96億ドル", direction: "逆風", sourceId: "pagerduty-q1fy27-earnings" },
      { label: "NRRが100%を下回る", detail: "ドルベース純増収率が97%(前年104%)に低下し、既存顧客からの純増収がマイナスに転じている", direction: "逆風", sourceId: "pagerduty-q1fy27-earnings" },
      { label: "株価は52週で大幅下落", detail: "52週高値$17.29から現在$11.10まで下落。アナリスト評価もHoldにとどまる", direction: "逆風", sourceId: "pagerduty-stock-forecast" },
    ],
    sourceIds: ["pagerduty-q1fy27-earnings", "pagerduty-stock-price", "pagerduty-stock-forecast"],
  },
  sellingPlaybook: {
  ...
  externalSignals: [
    ...
    {
      label: "株価の下落",
      value: "52週高値$17.29→現在$11.10",
      detail: "約36%の下落。",
      caveat: "市場全体の動向・個別要因の両方が影響している可能性がある。",
      sourceId: "pagerduty-stock-price",
    },
  ],
  roleLens: {
...
const amplitudeSources: ResearchSource[] = [
  ...
  {
    id: "amplitude-stock-price",
    label: "stockanalysis.com Amplitude(AMPL)株価データ",
    url: "https://stockanalysis.com/stocks/ampl/",
    kind: "外部集計",
    scope: "株価・時価総額・52週レンジ",
    checkedAt: "2026-08-07",
  },
  {
    id: "amplitude-stock-forecast",
    label: "stockanalysis.com Amplitude(AMPL)アナリスト予想",
    url: "https://stockanalysis.com/stocks/ampl/forecast/",
    kind: "外部集計",
    scope: "アナリスト目標株価コンセンサス",
    checkedAt: "2026-08-07",
  },
...
const amplitudeIntelligence: CompanyPublicIntelligence = {
  ...
  marketStatus: {
    ...
    priceAsOf: "2026-08-06",
    price: "$10.77",
    marketCap: "約$1.43B(約2,246億円)",
    week52Range: "$5.51〜$14.49",
    analystConsensus: "Buy",
    analystTargetAvg: "$12.82(現在値+19.03%)",
    analystTargetRange: "$8.50〜$18.00",
    analystCount: "12人",
    outlookSummary: "Q2 2026(2026年8月発表)決算は売上1.009億ドル(前年比+21.2%)と、初めて四半期売上1億ドルを突破した。ARRは4.10億ドル(前年比+22%)で、有機的な成長に加え、実験・フラグ管理ツールStatsigの買収も成長に寄与している。$100,000以上のARR顧客は824社(前年比+30%)と大口顧客の伸びが加速。通期売上ガイダンスも4.072億〜4.112億ドルへ上方修正された。決算後、複数のアナリストが目標株価を引き上げており、成長トレンドは明確に加速している。",
    outlookSignals: [
      { label: "初の四半期売上1億ドル突破", detail: "Q2 2026売上1.009億ドル(前年比+21.2%)", direction: "追い風", sourceId: "amplitude-q2-2026-earnings" },
      { label: "$100K+ARR顧客が前年比30%増", detail: "824社と大口顧客の伸びが加速している", direction: "追い風", sourceId: "amplitude-q2-2026-earnings" },
      { label: "Statsig買収による成長の一部は非有機的", detail: "ARR成長のうち一部は買収による寄与であり、既存事業だけの成長率とは分けて見る必要がある", direction: "中立", sourceId: "amplitude-q2-2026-earnings" },
    ],
    sourceIds: ["amplitude-q2-2026-earnings", "amplitude-stock-price", "amplitude-stock-forecast"],
  },
  sellingPlaybook: {
  ...
  facts: [
    ...
    { label: "ARR", value: "$410M(約6,437億円)", detail: "前年比+22%。Statsig買収の寄与を含む。1ドル=157円換算。", sourceIds: ["amplitude-q2-2026-earnings"] },
  ...
  hypotheses: [
    {
      ...
      counterSignals: ["ARR成長の一部はStatsig買収による寄与であり、既存事業単体の成長率はやや低い可能性がある"],
      interviewQuestions: ["ARR成長のうち、買収(Statsig)の寄与と既存事業の成長は、それぞれどれくらいの比率ですか"],
      sourceIds: ["amplitude-q2-2026-earnings"],
    },
    {
      topic: "M&A EXPANSION",
      title: "Statsig買収で、分析だけでなく「実験・意思決定」まで製品領域を拡大。",
      conclusion: "実験・フィーチャーフラグ管理ツールのStatsigを買収したことで、Amplitudeは「見る(分析)」だけでなく「試す・決める(実験)」まで一気通貫で提供する方向に製品戦略を広げていると考えられる。",
      confidence: "中",
      evidence: ["Statsig買収がARR成長の一部(1,700万ドル)に寄与"],
      counterSignals: [],
  ...
  externalSignals: [
    ...
    {
      label: "決算後のアナリスト目標株価引き上げ",
      value: "複数のアナリストが上方修正",
      detail: "Q2決算の好調を受けて、目標株価を引き上げる動きが見られた。",
      caveat: "個別のアナリスト名・金額までは確認できていない。",
      sourceId: "amplitude-stock-price",
    },
  ],
  roleLens: {
  ...
  salesAppeal: {
    ...
    points: [
      ...
      { title: "Statsig買収による製品領域の拡大", detail: "分析だけでなく実験・意思決定まで扱えるようになり、商談で語れる価値提案の幅が広がっている。", sourceIds: ["amplitude-q2-2026-earnings"] },
  ...
  interviewPrep: {
    ...
    questions: [
      { question: "ARR成長のうち、買収(Statsig)の寄与と既存事業の成長は、それぞれどれくらいの比率ですか。", why: "成長の中身(有機的成長か買収による寄与か)を正確に把握したい。", sourceIds: ["amplitude-q2-2026-earnings"] },
  ...
  solutions: [
    ...
    },
    {
      ...
      retention: "2026年のStatsig買収による統合で、比較的新しい製品領域。継続率データは非公開。",
    },
  ],

...
const oktaSources: ResearchSource[] = [
  ...
  {
    id: "okta-stock-price",
    label: "stockanalysis.com Okta(OKTA)株価データ",
    url: "https://stockanalysis.com/stocks/okta/",
    kind: "外部集計",
    scope: "株価・時価総額・52週レンジ",
    checkedAt: "2026-08-07",
  },
  {
    id: "okta-stock-forecast",
    label: "stockanalysis.com Okta(OKTA)アナリスト予想",
    url: "https://stockanalysis.com/stocks/okta/forecast/",
    kind: "外部集計",
    scope: "アナリスト目標株価コンセンサス",
    checkedAt: "2026-08-07",
  },
...
const oktaIntelligence: CompanyPublicIntelligence = {
  ...
  marketStatus: {
    ...
    ticker: "OKTA",
    exchange: "NASDAQ",
    priceAsOf: "2026-08-07",
    price: "$143.51",
    marketCap: "$24.94B(約3兆9,166億円)",
    week52Range: "$62.66〜$157.00",
    analystConsensus: "Buy",
    analystTargetAvg: "$129.02(現在値-10.10%)",
    analystTargetRange: "$75〜$175",
    analystCount: "44人",
    outlookSummary: "Q1 FY27(2026年5月発表)決算は売上7.65億ドル(前年比+11.2%)、サブスクリプション収益7.50億ドル(+11%)と底堅い成長を維持。$100,000以上のACV顧客が5,180件(+6%)、$1,000,000以上のACV顧客は570件(+19%)と大口顧客の増加が目立つ。一方でFY27通期の売上成長ガイダンスは9〜10%とやや減速を見込んでおり、Microsoft Entra IDとの競合が影響している可能性がある。株価は52週で大幅に上昇しており、アナリスト平均目標株価は現在の株価をやや下回る水準にとどまる。",
    outlookSignals: [
      { label: "大口顧客(ACV$100K+)の増加", detail: "5,180件(前年比+6%)、$1M以上の顧客は570件(+19%)と大口化が進む", direction: "追い風", sourceId: "okta-q1fy27-earnings" },
      { label: "通期成長ガイダンスは9〜10%に減速", detail: "直近四半期の11.2%成長からはやや減速する見通し", direction: "逆風", sourceId: "okta-q1fy27-earnings" },
      { label: "株価は52週で大幅上昇済み", detail: "52週安値から大きく上昇しており、平均目標株価は現在値をやや下回る", direction: "中立", sourceId: "okta-stock-forecast" },
    ],
    sourceIds: ["okta-q1fy27-earnings", "okta-stock-price", "okta-stock-forecast"],
  },
  sellingPlaybook: {
...
const zendeskIntelligence: CompanyPublicIntelligence = {
  ...
  marketStatus: {
    isPublic: false,
    ipoOutlookSummary: "2022年11月、Hellman & FriedmanとPermira主導の投資家グループが約102億ドルでZendeskを買収し、NYSE上場を廃止して非公開化した。2026年8月時点で、IPO(再上場)に関する公式な計画発表は確認できていない。プライベートエクイティ(PE)による買収は一般的に数年程度で売却・再上場等のイグジットを目指すケースが多いとされるが、これはZendesk固有の確認情報ではなく業界一般の傾向であり、具体的な時期を推測する根拠にはならない。日本事業は前年比約50%成長と、非公開化後も投資が継続していることを示すシグナルがある。",
    outlookSignals: [
      { label: "日本売上が前年比約50%成長", detail: "日本市場はZendeskの上位10市場の一つとされ、東京オフィスも拡張済み", direction: "追い風", sourceId: "zendesk-tokyo-expansion" },
      { label: "AI ARRが急拡大", detail: "2025年末時点で$200M、2026年は$400M〜$500Mを見込む", direction: "追い風", sourceId: "zendesk-stats-2026" },
      { label: "非公開化以降、財務詳細の開示が限定的", detail: "PE傘下のため四半期決算のような定期開示がなく、外部から成長性を検証しにくい", direction: "中立", sourceId: "zendesk-acquisition-press" },
    ],
    sourceIds: ["zendesk-acquisition-press", "zendesk-tokyo-expansion", "zendesk-stats-2026"],
  },
  sellingPlaybook: {
...
const uipathSources: ResearchSource[] = [
  ...
  {
    id: "uipath-stock-price",
    label: "stockanalysis.com UiPath(PATH)株価データ",
    url: "https://stockanalysis.com/stocks/path/",
    kind: "外部集計",
    scope: "株価・時価総額・52週レンジ",
    checkedAt: "2026-08-07",
  },
  {
    id: "uipath-stock-forecast",
    label: "stockanalysis.com UiPath(PATH)アナリスト予想",
    url: "https://stockanalysis.com/stocks/path/forecast/",
    kind: "外部集計",
    scope: "アナリスト目標株価コンセンサス",
    checkedAt: "2026-08-07",
  },
...
const uipathIntelligence: CompanyPublicIntelligence = {
  ...
  marketStatus: {
    ...
    priceAsOf: "2026-08-06",
    price: "$14.00",
    marketCap: "$7.25B(約1兆1,383億円)",
    week52Range: "$9.20〜$19.84",
    analystConsensus: "Hold",
    analystTargetAvg: "$13.25(現在値-5.36%)",
    analystTargetRange: "$10.98〜$17.00",
    analystCount: "20人",
    outlookSummary: "Q1 FY27(2026年5月発表)決算は売上4.18億ドル(前年比+17%)、ARRは19.01億ドル(前年比+12%)と、成長率の鈍化が続く中でも増収を確保した。$1M以上のARR顧客は374社(前年比+18%)と大口顧客の拡大が続いている。同四半期で創業以来初めてGAAPベースの黒字を達成した点も節目と言える。一方でアナリスト評価はHoldにとどまり、平均目標株価は現在の株価をやや下回る水準。RPA市場の成熟に伴い、エージェンティック・オートメーションへの転換が株価評価の鍵を握っていると考えられる。",
    outlookSignals: [
      { label: "初のGAAP黒字化", detail: "Q1 FY27で創業以来初めてGAAPベースの黒字を達成", direction: "追い風", sourceId: "uipath-q1fy27-earnings" },
      { label: "$1M+ARR顧客の拡大", detail: "374社(前年比+18%)と大口顧客の伸びが続く", direction: "追い風", sourceId: "uipath-q1fy27-earnings" },
      { label: "アナリスト評価はHoldにとどまる", detail: "平均目標株価は現在の株価をやや下回り、成長率鈍化への警戒も残る", direction: "中立", sourceId: "uipath-stock-forecast" },
    ],
    sourceIds: ["uipath-q1fy27-earnings", "uipath-stock-price", "uipath-stock-forecast"],
  },
  sellingPlaybook: {

...
const enteredSeeds: EnteredSeed[] = [
  ...
  { slug: "lakera", name: "Lakera", founded: "2021", jobUrl: "https://jobs.ashbyhq.com/lakera.ai/150abd1d-60a3-49ce-87b1-7a61806ab56e", officialUrl: "https://www.lakera.ai/", customersUrl: "https://www.lakera.ai/", financeUrl: "https://www.lakera.ai/careers", externalUrl: aiExternalUrl, role: "Enterprise AEとしてJapanのnew logo、sales strategy、partner、pilot、playbook、product feedbackを作る", category: "AI Security and LLM Guardrails Platform", buyer: "CISO・AI Platform・Application Security・ML Engineering・Risk", departments: "SecurityからAI Platform、Product、Engineering、Data、Risk、Legal、経営層", problems: ["employee・application・agentのLLM利用が増えprompt attackとdata leakageの境界が見えない", "modelとuse caseが変わるたびsecurity testとpolicy enforcementを作り直す", "AIのsafety・securityをproductionで継続監視し経営へ説明できない"], origin: "LLMを攻撃する公開game GandalfとAI red teamingの知見を起点に、prompt injection、unsafe content、data loss等をruntimeで検知・制御するGuardへ拡張。現在はCheck PointのAI security portfolioの一部。", external: "AI agentが社内systemとcustomer workflowへ接続するほど、企業はmodel精度だけでなく入力・出力・tool action・data accessをrisk-basedで統制する必要がある。", value: "unsafe interaction、manual review、security test、incident response、AI release frictionを改善", objection: "model providerのsafety機能、WAF、DLP、manual red teamで十分。", reframe: "単発filterではなく、model非依存のruntime control、attack test、policy、latency、false positiveを実際のapplicationで比較する。", headcount: "51〜200人規模", japanPresence: "Remote Japan / Tokyo preferred", japanSince: "2026年にJapan Enterprise AE採用を確認", growth: "Check Point傘下でAI securityを展開。公式求人ではFortune 500、startup、foundation model providerでの利用と、日本のsales strategyを一から作る段階を案内。", facts: ["Fortune 500等で利用（社名非公表）", "Lakera GuardとGandalf", "日本固有の顧客事例は未確認", "Enterprise Account Executive, Japan"], customers: ["Fortune 500企業（社名非公表）", "AI startup（社名非公表）", "foundation model provider（社名非公表）"], solutions: ["Lakera Guard", "Gandalf", "AI Security Testing"], competitors: "Protect AI、HiddenLayer、model provider標準guardrail", fit: ["AI Security", "LLM", "Guardrails", "Japan Build", "Enterprise", "Partner"] },
];

...
export const jobs20260816: Job[] = [
  ...
  },
  {
    ...
    reputationResearch: {
      researchedAt: "2026-08-17",
      summary: "Adyen東京の営業チームだけを十分な件数で評価した公開レビューは確認できないため、グローバルの匿名社員レビューを集計した。【Genba仮説】Team Lead, Salesの活躍条件は、個人の受注力だけでなく、quota・territory・採用・ramp・forecastをteam単位で再現できる裁量と支援があること。",
      positiveTopics: [
        "【海外レビュー参考】Glassdoor、Comparably、Indeedでは、国際的な案件、優秀な同僚、フラットな議論、早期からの責任を肯定する声が見られる。",
        "【Genba仮説】Sales Team Leadでは、sellerを採用・育成し、pipelineとforecastを改善できる環境なら、個人AEを超えた市場価値を作りやすい。",
        "組織文化：階層が比較的フラットで、役職にかかわらず意見を伝えやすく、経営・管理職へ異論を述べやすいという声がある。",
        "国際的な経験：国や拠点をまたぐ協業やグローバル案件が多く、異なる市場・職種のメンバーと働ける点を評価する声がある。",
        "働きやすさ：Glassdoorではワークライフバランスが5点中4.0。Comparablyでは回答者の75%が満足と回答し、営業部門の評価も高い。",
        "人と成長機会：優秀な同僚、興味深い案件、早期から責任を任される環境、社員交流への投資を肯定する声がある。",
      ],
      negativeTopics: [
        "【海外レビュー参考】評価・昇進、managerの質、意思決定の透明性、業務負荷には地域・teamで異なる声がある。",
        "【Genba仮説】面接では過去4四半期のteam quota達成者比率、territory変更、未充足headcount、ramp期間、manager育成実績、Japan planの決定権を数字で確認すべき。",
        "評価・昇進：昇進基準が見えにくく、上司との関係や社内政治の影響を感じる、キャリアの進展が遅いという声がある。",
        "マネジメント・チーム差：上司の経験、フィードバックの質、意思決定の透明性、文化の実践度が配属チームによって異なるという声がある。",
        "仕事の速さと負荷：変化と意思決定が速く、自律性を求められる一方、Comparablyでは回答者の33%が燃え尽きを感じると回答している。",
        "報酬・リーダーシップ：Glassdoorでは報酬・福利厚生3.5、上級管理職3.2。Comparablyでもリーダーシップと報酬への評価は相対的に弱い。",
      ],
      caveat: "レビューは投稿者の職種・国・在籍時期・上司によって体験が異なり、日本拠点や本求人へそのまま当てはめることはできない。あくまで匿名の評判・噂なので、面接などで聞いてみましょう。",
      sources: [
        { label: "Glassdoor Adyen社員レビュー", url: "https://www.glassdoor.com/Reviews/Adyen-Reviews-E684495.htm", detail: "914件の集計で総合3.6、友人への推奨70%、ワークライフバランス4.0、文化・価値観3.7、報酬・福利厚生3.5、キャリア機会3.2、上級管理職3.2。国・職種横断の匿名集計。" },
        { label: "Comparably Adyen社員レビュー", url: "https://www.comparably.com/companies/adyen/reviews", detail: "公開された38件の社員レビューの78%が肯定的。組織文化、チーム、環境、経営への意見を含むが、日本限定ではない。" },
        { label: "Comparably ワークライフバランス", url: "https://www.comparably.com/companies/adyen/work-life-balance", detail: "35人の回答で75%が満足、33%が燃え尽きを感じると回答。営業部門はワークライフバランスを高く評価しているが、標本は小さい。" },
        { label: "Indeed Adyen社員レビュー", url: "https://www.indeed.com/cmp/Adyen/reviews?fcountry=ALL", detail: "社員イベント、早期からの責任、柔軟性を評価する声と、官僚化、文化の実践度、リーダーシップへの批判が併存する。11件と少数の匿名投稿。" },
      ],
    },

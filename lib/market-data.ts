...
import { companies20260831Daily, jobs20260831Daily } from "@/lib/company-additions-2026-08-31-daily";
import { companies20260901Daily, jobs20260901Daily } from "@/lib/company-additions-2026-09-01-daily";
...
import { companies20260913Daily, jobs20260913Daily } from "@/lib/company-additions-2026-09-13-daily";
...
import { companies20260920Daily, jobs20260920Daily } from "@/lib/company-additions-2026-09-20-daily";
import { companies20260921Daily, jobs20260921Daily } from "@/lib/company-additions-2026-09-21-daily";
...
const companyRecords: Company[] = [
  ...
  ...companies20260831Daily,
  ...companies20260901Daily,
  ...
  ...companies20260920Daily,
  ...companies20260921Daily,
...
export const companies = publishedCompanyRecords.map((company): Company => {
  ...
  const auditedLastChecked = "2026-09-22";
...
const signalRecords: Signal[] = [
  {
    ...
    summary: "公式求人URLが404となったため公開求人から除外しました。これだけで採用停止や日本事業縮小を示すものではありません。",
  ...
  },
  {
    ...
    type: "組織シグナル",
    confidence: "公式確認",
    title: "Channel TalkのCustomer Experience求人が終了",
  ...
  },
  {
    ...
    type: "組織シグナル",
    confidence: "公式確認",
    title: "Criblの東京Delivery Manager求人が終了",
    summary: "公式Greenhouse APIから求人ID 6137610004が消失し、直接URLも404となったため公開求人から除外しました。これだけで日本の採用停止や事業縮小を示すものではありません。",
    source: { label: "Cribl Careers (Greenhouse API)", url: "https://boards-api.greenhouse.io/v1/boards/cribl/jobs" },
  },
  {

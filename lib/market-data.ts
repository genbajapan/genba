...
export const jobs: Job[] = [
  ...
  },
  {
    ...
    careerInsights: {
      ...
      tenureAndPromotion: "Celonis Japanは2019年設立と組織が若く、全社的な平均勤続年数の公開データはない。OpenWorkの回答者4件も在籍3年未満〜3〜5年が中心。ただしLinkedIn公開プロフィールでは、Head of Sales, Japanの山下和正氏が2022年1月着任で2026年8月時点で在籍4年8か月と、シニア層では複数年単位の在籍例も確認できる。同氏はOtsuka Shokai(8年)→webMethods(1年)→JustSystems(1年)→Hewlett-Packard Software(6年10か月、Sales Director)→ServiceNow(5年10か月、Senior Director Sales)という、エンタープライズソフトウェアベンダーを一社あたり数年単位で渡り歩くキャリアを経てCelonisに合流しており、社内評価の詳細は不明ながら、営業幹部への登用は業界内での長期キャリア実績が前提になっている可能性がある(いずれもLinkedIn公開プロフィールより)。",
      priorCompanies: "LinkedIn公開プロフィールで確認できる実例として、2026年6月に東京拠点のAccount Executiveとして入社した人物は、化学工学の修士号を持ち、プロセス産業向けエンジニアリング/シミュレーションソフトウェアのAspen Technologyで10年超(ビジネスコンサルタント3年6か月→シニアセールスアカウントマネージャー6年8か月)を務め、直前にMinitab(統計解析ソフトウェア)を短期間経てCelonisへ移っている。Portfolio AEが製造業限定のターゲティングであることを踏まえると、Aspen Technologyのようなプロセス産業向けエンジニアリングソフトウェア、SAP・Oracle等のERPベンダー、あるいはCelonisの国内パートナーである伊藤忠テクノソリューションズ・日立システムズ等のSIer出身者が採用されやすいと考えられる(実例1件+求人要件からの推測)。",
      nextCompanies: "Celonis Japanは2019年設立とまだ若く、退職者の転職先を追えるLinkedIn公開データは限定的。参考として、2019〜2021年に代表取締役として日本法人の立ち上げを主導した小林裕亨氏は、Celonis退任後の2023年から上智大学大学院応用データサイエンス学位プログラムの准教授に転じ、プロセスインテリジェンスの知見を教育・研究の場で活かしている(経営層の事例であり、AE個人の転職先データとは性質が異なる点に留意)。AEレベルの退職後キャリアを示す公開データはまだ確認できていないが、新規ロゴ獲得の実績は、他の業務改善・DX系SaaS企業(UiPath、SAP Signavio等)のEnterprise AE、またはCelonisパートナー企業(NEC・富士通・アクセンチュア等)側のプロセスマイニング関連職への転職材料になりやすいと考えられる(製品領域の隣接性からの仮説)。",
    },
  },
  {
    ...
    careerInsights: {
      ...
      tenureAndPromotion: "新設ポジションのため前任者データはない。参考として、Celonis JapanのHead of Sales, Japan山下和正氏は2022年1月着任で2026年8月時点で在籍4年8か月、OpenWorkの回答者4件も在籍3年未満〜3〜5年が中心で、2019年設立とまだ若い組織であることを踏まえると、シニアポジションでも数年単位の在籍がひとつの目安になり得る(LinkedIn公開プロフィール・OpenWorkより)。",
      priorCompanies: "求人要件(10年以上のアライアンス/パートナー管理または戦略コンサルティング経験、NEC・富士通・ABeamを含む国内SIerエコシステムでの確立されたネットワーク)から、これら大手SIerやCelonisの他の国内パートナー(伊藤忠テクノソリューションズ・日立システムズ・アクセンチュア・IBM Japan等)側でアライアンス・パートナーセールスを務めた経験者、または戦略コンサルティングファーム出身者が中心になると考えられる。現Head of Sales, Japanの山下和正氏がHP Software→ServiceNowという「エンタープライズソフトウェアベンダーを渡り歩くシニア営業人材」のキャリアパターンを持つ実例もあり、同様に大手エンタープライズソフトウェア企業のアライアンス部門出身者が採用される可能性もある(実例からの類推+求人要件)。",

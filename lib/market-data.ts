...
export const jobs: Job[] = [
  ...
  },
  {
    ...
    careerInsights: {
      ...
      tenureAndPromotion: "Celonis Japanの離職率・在籍年数の公開データは確認できていない。OpenWorkには回答4件のみで、平均残業17.9時間・有休消化率60.8%という数値がある。",
      priorCompanies: "求人要件から、他の外資エンタープライズソフトウェア企業でのフィールドセールス経験者が中心になると考えられる(求人要件からの読み解き)。",
      nextCompanies: "確認できる公開データはない。新規ロゴ獲得の実績は、他の業務改善・DX系SaaS企業のEnterprise AEへの転職材料になりやすいと考えられるが、これは未確認の一般論。",
    },
  },
  {
    ...
    careerInsights: {
      ...
      tenureAndPromotion: "Celonis Japanの離職率・在籍年数の公開データは確認できていない。",
      priorCompanies: "求人要件から、他の外資エンタープライズソフトウェア企業でアライアンス・パートナー管理職を務めた経験者、または戦略コンサルティングファーム出身者が中心になると考えられる(求人要件からの読み解き)。",
      nextCompanies: "確認できる公開データはない。パートナーエコシステム構築の実績は、他社のアライアンス責任者職や大手SIer側のパートナー窓口への転職材料になりやすいと考えられるが、これは未確認の一般論。",
    },
  },
];

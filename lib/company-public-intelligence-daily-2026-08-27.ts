...
const glanceIntelligence = build({
  ...
  milestones: [
    ...
    { year: "2025.08", label: "日本launch", detail: "Sharp AQUOS R10へGlance AIを搭載。", source: "company" },
  ...
  heroSummary: "検索前の着想を、mobile・TV等の日常surfaceからpersonalizedな商品発見と販売サイトへの遷移へつなぐ。端末や小売の差別化、利用者activation、commerce収益を同時に改善する。",
...
const getYourGuideIntelligence = build({
  ...
  growthSummary: "2009年創業。会社公式はFY2025に売上10億ユーロ超、GMV40億ユーロ超、3,300万件超の体験予約、5万の供給partner、20万超の体験、1.8万destination、黒字化を発表。日本別の数字は非公開。",
  ...
  milestones: [
    ...
    { year: "2025", label: "黒字化と規模拡大", detail: "売上10億ユーロ超、GMV40億ユーロ超、3,300万件超を公式発表。", source: "finance" },
    { year: "2026.08", label: "Tokyo採用", detail: "Business Development ManagerとDMO Partnerships Leadを公式Careersで確認。", source: "job" },
  ],
  issueLenses: [
  ...
  facts: [
    ...
    { label: "FY2025売上", value: "10億ユーロ超", detail: "会社公式発表。", source: "finance" },
    { label: "FY2025 GMV", value: "40億ユーロ超", detail: "会社公式発表。", source: "finance" },
  ...
  heroSummary: "分散するtour・体験・attractionを、海外旅行者が発見・予約できる供給へ変える。多言語の需要、在庫、予約、reviewをつなぎ、供給者の稼働と増分売上を改善する。",
  ...
  evidence: "FY2025に売上10億ユーロ超、GMV40億ユーロ超、3,300万件超、黒字化を公式発表。日本個社の定量成果は未公開。",
...
applyStandard(antithesisIntelligence, buildCompactPatch({
  ...
  targets: ["CTO・VP Engineering", "SRE・Software Reliability責任者", "Distributed Systems・Platform Engineering責任者"],

...
export function getHeadquartersRegion(headquarters: string): Exclude<HeadquartersRegion, "すべて"> | "other" {
  ...
  if (/UK|Germany|France|Switzerland|Ireland|Netherlands|Belgium|Sweden|Finland|英国|ドイツ|フランス|スイス|アイルランド|オランダ|ベルギー|スウェーデン|フィンランド|\bNL\b/.test(primaryHeadquarters)) return "europe";
  return "other";
}

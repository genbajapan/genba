...
export const companies20260813WaveThree: Company[] = [
  { slug: "cato-networks", name: "Cato Networks", category: "SASE / Cloud Networking & Security", broadCategory: "セキュリティ・IT運用", hq: "Tel Aviv, Israel", japanPresence: "Cato Networks株式会社 / Tokyo", hiringStatus: "積極採用", salesRoles: 10, description: "networkingとsecurityをsingle cloud platformへ統合するSASE vendor。日本でSales、Presales、Customer Success、Supportの10職を募集。", lastChecked: "2026-08-17", careersUrl: "https://www.catonetworks.com/careers/", tags: ["SASE", "Networking", "Security", "Customer Success", "Enterprise"] },

...
built.adyen.aeInterviewHypotheses = {
  intro: "前半で確認した会社・市場・求人の事実から一歩進み、入社後の達成難度を左右する未公開情報だけを抽出した。質問は仮説を先に示してから尋ねることで、単なる情報収集ではなく、営業責任者として事業構造を理解しようとしている姿勢が伝わるように設計している。",
  items: [
    {
      issue: "日本の営業余地",
      hypothesis: "日本の初期案件は、純粋な国内新規顧客だけでなく、海外で契約済みのグローバル顧客による日本展開・追加導入が相応の割合を占める可能性がある。",
      question: "日本チームの新規純収益は、国内で新たに開拓した顧客と、海外で契約済みのグローバル顧客による日本展開で、現在どの程度の構成になっていますか？",
      goodSignal: "構成比、代表案件、今後増やしたい顧客群を数字と具体例で説明できる。",
      cautionSignal: "『両方ある』で終わり、新規開拓余地や引き継げる既存基盤が見えない。",
      sourceIds: ["adyen-customers", "adyen-on-japan", "adyen-job"],
    },
    {
      issue: "営業の評価単位",
      hypothesis: "取扱高が大きくても採算が低い案件があり得るため、営業評価は契約額ではなく、純収益、決済取扱高、複数製品の導入、稼働開始を組み合わせて決まる可能性がある。",
      question: "大規模顧客の案件では、決済取扱高、純収益、複数製品の導入、稼働開始のうち、どの指標が営業成果として最も重く評価されますか？",
      goodSignal: "評価指標、成果配分、長期案件や海外連携案件の扱いを明確に説明できる。",
      cautionSignal: "目標額だけが示され、採算、稼働時期、他チームとの成果配分が曖昧。",
      sourceIds: ["adyen-annual-report-2025", "adyen-job"],
    },
    {
      issue: "契約から稼働までの制約",
      hypothesis: "決済は契約後も審査、接続、セキュリティ、店舗展開が必要であり、営業力より導入・リスク部門の処理能力が日本の売上成長を制約している可能性がある。",
      question: "日本では契約から本番稼働までの中央値はどれくらいで、遅延理由の上位3つは何ですか？ この役割は期間短縮にどこまで責任を持ちますか？",
      goodSignal: "中央値、主な遅延理由、部門別責任、営業が改善できる範囲を説明できる。",
      cautionSignal: "『案件による』で終わる一方、稼働遅延も営業目標へ含まれる。",
      sourceIds: ["adyen-acquiring-japan", "adyen-unified-commerce-japan", "adyen-job"],
    },
    {
      issue: "国内競合への勝ち筋",
      hypothesis: "国内PSPや既存アクワイアラーからの移行負荷が大きいため、Adyenが勝ちやすいのは、複数国・複数チャネル・不正対策・照合を同時に変える必要がある大企業に限られる可能性がある。",
      question: "日本でAdyenが最も勝ちやすい顧客条件と、最終選考で国内PSPやStripeに負ける典型的な理由を、それぞれ教えてください。",
      goodSignal: "業界、企業規模、システム構成、競合別の勝因・敗因を具体的に説明できる。",
      cautionSignal: "製品の優位性だけを語り、移行負荷、価格、国内機能差への認識が薄い。",
      sourceIds: ["adyen-customers", "adyen-on-japan", "adyen-wolt-japan"],
    },
    {
      issue: "営業リーダーの実権",
      hypothesis: "Team Leadという肩書でも、価格、担当顧客、採用、評価、製品要望は日本、APAC、本社で分担され、日本独自に決められる範囲は限定的な可能性がある。",
      question: "この役割が単独で決められることと、Head of Sales Japan、APAC、本社の承認が必要なことを、価格、担当設計、採用、評価、製品要望に分けて教えてください。",
      goodSignal: "決裁範囲と承認経路が明確で、日本側から変更できた具体例がある。",
      cautionSignal: "売上責任は大きい一方、採用、価格、担当設計をほとんど動かせない。",
      sourceIds: ["adyen-job", "adyen-country-manager-japan", "adyen-formula"],
    },
  ],
};

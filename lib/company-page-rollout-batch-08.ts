...
function patchCohere(intelligence: CompanyPublicIntelligence) {
  ...
  applyStandard(intelligence, buildCompactPatch({
    slug: "cohere", leaderName: "Aidan Gomez", leaderLabel: "Co-founder・CEO", leaderUrl: "https://cohere.com/about", localName: "Hyonju Cho", localLabel: "Country Manager, Japan（公開プロフィール）", localUrl: "https://jp.linkedin.com/in/hyonjucho",
    ...
    unresolved: [["財務の確度", "監査済み売上・利益は非公開で、ARRは二次報道。", "recognized revenue、ARR、gross margin、burn、FCF、retentionは？"], ["日本体制", "公開プロフィールのCountry ManagerとRemote 3求人、Fujitsu提携は確認。", "日本法人、雇用主体、現在人数、support・delivery capacityは？"], ["Private AIの実装", "VPC・on-prem・air-gappedを訴求。", "GPU sizing、upgrade、SLA、incident、data boundary、cost責任は？"], ["Direct・Partner", "AE、PDM、FDEを同時募集。", "account ownership、sourced・influenced credit、FDE coverage、partner delivery責任は？"], ["報酬・達成", "3求人とも給与・OTE・quotaは非公開。", "pay mix、quota、ramp、attainment、POC-to-production、equityは？"]],
  }));
  intelligence.facts = [
  ...
  addSources(intelligence, [
    ...
    { id: "rollout-cohere-japan-leader-profile", label: "Hyonju Cho 公開LinkedInプロフィール", url: "https://jp.linkedin.com/in/hyonjucho", kind: "外部集計", scope: "Country Manager, Japan・東京所在の公開職歴", checkedAt: "2026-08-19" },

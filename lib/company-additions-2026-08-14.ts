...
const replacementSeeds = [
  { id: "wasabi-inside-sales-representative-japan", slug: "wasabi", title: "Inside Sales Representative - Japan", segment: "Inside Sales / Cloud Storage", location: "日本", workStyle: "公式求人で明記なし", language: "日本語（native）／英語（basic以上）", url: "https://job-boards.greenhouse.io/wasabi/jobs/5382765008", summary: "JapanのSMB・Mid-Market案件を80%管理・closeし、20%は新規機会を発掘・qualifyしてChannel Account teamへ渡す。", take: "容量単価ではなく、egress、予測可能性、backup・archive・AI dataのTCOを短いdiscoveryで見極める。", profile: "公式求人はtechnology inside sales 3年以上、native Japanese、basic以上のEnglishを求める。storage・backup・channel経験は歓迎。", fit: "cloud infrastructureのcategory educationとinside full-cycle salesを磨きたい人に向く。", value: "Cloud Storage、FinOps、Inside Salesの経験。" },
